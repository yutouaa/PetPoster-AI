...
import { cleanup, genChangelog, generateRoute, gitCommit, gitCommitVerify, printSoybean, release, updatePkg } from './commands';
...
export async function setupCli() {
    ...
    cli
        ...
        .option('-c, --cleanupDir <dir>', 'The glob pattern of dirs to cleanup, If not set, it will use the default value, Multiple values use "," to separate them')
