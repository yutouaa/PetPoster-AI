...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'petposter_templates',
        path: '/petposter/templates',
        component: 'view.petposter_templates',
        meta: {
          title: 'petposter_templates',
          i18nKey: 'route.petposter_templates',
