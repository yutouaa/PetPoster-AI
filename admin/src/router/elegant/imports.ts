...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "petposter_ai-providers": () => import("@/views/petposter/ai-providers/index.vue"),
  "petposter_audit-log": () => import("@/views/petposter/audit-log/index.vue"),
  petposter_dashboard: () => import("@/views/petposter/dashboard/index.vue"),
  "petposter_failed-tasks": () => import("@/views/petposter/failed-tasks/index.vue"),
  petposter_generations: () => import("@/views/petposter/generations/index.vue"),
  petposter_quota: () => import("@/views/petposter/quota/index.vue"),
  petposter_templates: () => import("@/views/petposter/templates/index.vue"),
  "petposter_xhs-posts": () => import("@/views/petposter/xhs-posts/index.vue"),
