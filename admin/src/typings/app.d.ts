...
declare namespace App {
    ...
    type Schema = {
      ...
      page: {
        ...
        home: {
          ...
          revenue: string;
          taskDuration: string;
          taskDurationP50: string;
          durationAvg: string;
          sampleSize: string;
          timeouts24h: string;
          failureBreakdown: string;
          failureType: string;
          retryEffectiveness: string;
          failureTypes: {
            timeout: string;
            api_error: string;
            rate_limit: string;
        ...
        petposter: {
          ...
          quota: {
            ...
            needUserId: string;
            amountNotZero: string;
            adjustSuccess: string;
            adjustFailed: string;
            txDialogTitle: string;
            txType: string;
            txAmount: string;
          ...
          failedTasks: {
            ...
            createdAt: string;
            selectFirst: string;
            confirmBatchRetry: string;
            confirmBatchRetryTitle: string;
            confirmRetryBtn: string;
            retrySuccess: string;
            retryFailed: string;
          };
          templateStats: {
          ...
          xhs: {
            ...
            confirmTitle: string;
            aiGenDialogTitle: string;
            aiGenPromptPlaceholder: string;
            aiGenButton: string;
            aiGenSuccess: string;
  ...
  namespace Service {
    ...
    type Response<T = unknown> = {
      ...
      msg: string;
      /** PetPoster API error code */
      errorCode?: string;
      /** PetPoster API message */
      message?: string;
      /** The backend service response data */
      data: T;
    };
